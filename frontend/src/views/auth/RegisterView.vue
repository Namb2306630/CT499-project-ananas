...
const register = async () => {
  ...
  if (res?.code === 200) {
    ...
    const message =
      Object.values(authStore.error.errors)[0] || authStore.error.general || 'Lỗi tạo tài khoản!!!'
    ...
    <form class="register-form" @submit.prevent="register">
      ...
      <div class="confirm-password">
        <input
          ...
          id="confirm-password"
          v-model="authUser.confirmPassword"
        />
        <i
          class="fa-regular"
      ...
      <p v-if="error.errors.confirmPassword" class="m-0 error">
      ...
      <div class="register-agreement">
        <p class="p-0 m-0">
          Bằng việc đăng ký, bạn đã đồng ý với Ananas về
      ...
      <div class="login">
        <p class="p-0 m-0">
          Bạn đã có tài khoản?<RouterLink
